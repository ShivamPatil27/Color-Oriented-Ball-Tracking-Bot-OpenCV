...
GPIO_TRIGGER1 = 29      #left us
GPIO_ECHO1 = 31

GPIO_TRIGGER2 = 36      #front us
GPIO_ECHO2 = 37

GPIO_TRIGGER3 = 33      #right us
GPIO_ECHO3 = 35
...
def segment_colour(frame):    #returns only the red colors in the frame
    ...
    ycr_roi=cv2.cvtColor(frame,cv2.COLOR_BGR2HSV)
...
def find_blob(blob): #returns the red colored circle
    largest_contour=0
    cont_index=0
    a,contours, hierarchy = cv2.findContours(blob, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
